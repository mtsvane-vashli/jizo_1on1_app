      ...
      >
        <div>
          ...
          <nav className={styles.nav}>
            <NavLink to="/app/new-1on1" onClick={handleLinkClick} className={({ isActive }) => isActive ? `${styles.navLink} ${styles.active}` : styles.navLink}>
              <FiMessageSquare />
              <span className={styles.navText}>新規1on1支援</span>
            </NavLink>
            <NavLink to="/app/logs" onClick={handleLinkClick} className={({ isActive }) => isActive ? `${styles.navLink} ${styles.active}` : styles.navLink}>
              <FiFileText />
              <span className={styles.navText}>セッションログ</span>
            </NavLink>
            <NavLink to="/app/dashboard" onClick={handleLinkClick} className={({ isActive }) => isActive ? `${styles.navLink} ${styles.active}` : styles.navLink}>
              <FiGrid />
              <span className={styles.navText}>ダッシュボード</span>
            </NavLink>
            <NavLink to="/app/resources" onClick={handleLinkClick} className={({ isActive }) => isActive ? `${styles.navLink} ${styles.active}` : styles.navLink}>
              <FiBook />
        ...
        <div className={styles.sidebarFooter}>
          <NavLink to="/app/settings" onClick={handleLinkClick} className={({ isActive }) => isActive ? `${styles.navLink} ${styles.active}` : styles.navLink}>
            <FiSettings />
